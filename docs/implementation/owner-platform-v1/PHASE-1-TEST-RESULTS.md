...
| 4 | `corepack pnpm test` | passed | exit 0; **299 files / 2,698 tests**, all passing — app 218 files/2,113 tests, isolated `lib/evidence/safe-media.test.ts` 1/62, `packages/region` 3/23, `packages/scoring` 16/183, `packages/contracts` 3/20, `packages/scan-engine` 28/297 |

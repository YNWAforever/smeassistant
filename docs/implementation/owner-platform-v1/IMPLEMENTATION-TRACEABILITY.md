...
| Resolve the recovery-link promise | in progress | The field is persisted but never read back to deliver anything; an honest "recovery unavailable" message already exists, orphaned, in `lib/messages/*`. Design + adversarial review in flight. |

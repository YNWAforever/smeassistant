...
Findings 5, 13, 14 and 15 are the whole `promises-copy` area, and closing it as a set is what surfaced three more of the same kind that the 14-agent audit missed — recorded below as **P1–P3**. **P3 is now fixed** (built, not reworded: the disconnect control it promised now exists). P1 and P2 remain open.

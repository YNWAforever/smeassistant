...
it("SDK exchanges callback challenge and redirects to completion before app actions",async()=>{
 ...
 expect(response.headers.get("location")).toBe("https://app.test/zh-TW/owner/sign-in/complete?returnTo=%2Fzh-TW%2Fowner");

...
export async function POST(
  ...
  const mode =
    body?.mode === "export" || body?.mode === "copy" ? body.mode : null;
  ...
  try {
    ...
    const workspace = await auth.repository.assistantWorkspace(
    ...
    console.error("[api/versions/export] failed", {
      category: "version_export_failed",
    });
